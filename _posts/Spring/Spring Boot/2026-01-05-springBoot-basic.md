...
### 개요	
- 시스템을 제어하는 데 쓰이는 기계 장치
- 프로덕션 준비 기능을 편리하게 사용할 수 있게 한다.
    - 프로덕션 준비 기능 : 애플리케이션이 현재 살아있는지, 로그 정보는 정상 설정 되었는지, 커넥션 풀은 얼마나 사용되고 있는지 등을 확인
...
- JMX(Java Management Extensions) 
	- 실행 중인 자바 애플리케이션의 상태를 모니터링하고, 설정을 관리하기 위한 자바 표준 기술
- 마이크로미터 추상화
    - <img src="/assets/img/kyh_java/mm1.png" width="600px" />
