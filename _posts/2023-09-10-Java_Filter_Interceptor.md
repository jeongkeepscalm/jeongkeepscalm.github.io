...
사용해서 등록하면 된다. <br/>
> - setFilter(new LogFilter()) : 등록할 필터를 지정한다. LogFilter 파일은 Filter 를 상속받아 구현한 파일이다. <br/>
...
<img src="/assets/img/interceptor.png" width="500px"  border="3px"/>
...
```
> 인증이라는 것은 컨트롤러 호출 전에만 호출되면 되기에 preHandle 만 구현하면 된다. <br/>
