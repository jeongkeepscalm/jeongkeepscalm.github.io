...
```
> validation 함수 내, 비동기 통신으로 데이터를 받아와야 하는 값이 있어 async await 을 사용했고, </br>
...
> formData.append('files', file); </br>
> 비동기 통신으로 form을 넘긴다. 매개변수 VO 안에는 필드명 private List<MultipartFile> files 를 가지고 있고, files에 담기게 된다.  </br>
